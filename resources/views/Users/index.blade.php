                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">تایم
                                        لاین</a></li>
                                <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">تنظیمات</a>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                        ...
                        <span class="bg-success">
                          3 Jan. 2014
                                ...
                                <div class="tab-pane" id="settings">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName"
                                                       placeholder="نام" name="name" value="{{auth()->user()->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" id="inputEmail"
                                                       placeholder="ایمیل" name="email" value="{{auth()->user()->email}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputName2" class="col-sm-2 control-label">موبایل</label>

                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName2"
                                                       placeholder="موبایل" value="{{auth()->user()->mobile}}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputExperience"
                                                   class="col-sm-2 control-label">معرفی</label>

                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="inputExperience"
                                                          placeholder="درباره من ... " name="about">{{!is_null(auth()->user()->about)}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSkills" class="col-sm-2 control-label">مهارت ها</label>

                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputSkills"
                                                       placeholder="مهارت ها" name="skill">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <a href="{{route('twoFactorAuth')}}" class="btn btn-warning">احراز هویت دو مرحله
                                            ای</a>
                                    </div>
                                </div>
                                <!-- /.tab-pane -->
